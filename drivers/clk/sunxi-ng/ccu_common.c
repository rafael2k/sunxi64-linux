...
static int sunxi_ccu_probe(struct sunxi_ccu *ccu, struct device *dev, //T
			   struct device_node *node, void __iomem *reg,
			   const struct sunxi_ccu_desc *desc)//T
static int ccu_rate_reset_notifier_cb(struct notifier_block *nb,//O
				      unsigned long event, void *data)
{
...
int sunxi_ccu_probe(struct device_node *node, void __iomem *reg,
		    const struct sunxi_ccu_desc *desc)//O
{
	struct ccu_reset *reset;
	int i, ret;
