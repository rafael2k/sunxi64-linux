				   ...
				   struct v4l2_fwnode_endpoint* vep)
{
	...
	case V4L2_PIX_FMT_NV12_16L16://T
	case V4L2_PIX_FMT_RGB555://O
		return mbus_code == MEDIA_BUS_FMT_RGB555_2X8_PADHI_LE;

	case V4L2_PIX_FMT_HM12://O
	case V4L2_PIX_FMT_NV12:
	case V4L2_PIX_FMT_NV21:
	case V4L2_PIX_FMT_NV16:
	case V4L2_PIX_FMT_NV61:
...
static int sun6i_csi_v4l2_init(struct sun6i_csi *csi)
{
	...
	ret = v4l2_async_nf_parse_fwnode_endpoints(csi->dev,//T
						   &csi->notifier,
						   sizeof(struct
							  v4l2_async_subdev),
						   sun6i_csi_fwnode_parse);//T
	ret = v4l2_async_notifier_parse_fwnode_endpoints(csi->dev,//O
					 &csi->notifier,
					 sizeof(struct sun6i_csi_async_subdev),
					 sun6i_csi_fwnode_parse);//O
	if (ret)
		goto clean_video;
